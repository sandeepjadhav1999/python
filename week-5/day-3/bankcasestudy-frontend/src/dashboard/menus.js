...
export function AppMenu() {
    ...
    const onMenuClick = (menu) => {
        ...
        if (menu.header === 'Deposit') navigate ('deposits')
        if (menu.header === 'Withdraw') navigate('withdraw')
        if (menu.header === 'Transfer') navigate('transfer')
        if (menu.header === 'Account') navigate('account')
        if (menu.header === 'Status') navigate('status')
        if (menu.header === 'Balance') navigate('balance')
    }
