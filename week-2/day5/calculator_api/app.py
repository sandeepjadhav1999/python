...
def multiplication(num1: int, num2: int):
    return {'status': 'success', 'message': 'multiplication performed successfully', 'result': (num1 * num2)}

@app.route('/subtraction/<int:num1>/<int:num2>')
def subtraction(num1: int, num2: int):
    return {'status': 'success', 'message': 'subtraction performed successfully', 'result': (num1 - num2)}

@app.route('/division/<int:num1>/<int:num2>')
def division(num1: int, num2: int):
    return {'status': 'success', 'message': 'division performed successfully', 'result': (num1 / num2)}
