...
export function Registration() {
    ...
    const [formData, setFormData] = useState({mobile:'',name:'',email:'',dob:'',location:'',status:''})
    ...
    const makePostRequest = useCallback(() => {
        ...
        fetch('http://localhost:5000/customer',{method:'POST',body:JSON.stringify(formData),headers:{'Accept':'application/json','Content-Type':'application/json'}})
            .then(dt => {
